...
const globCallback = __importStar(require("glob"));
const LICENSE = `/**
...
class LicenseTransformer extends stream_1.Transform {
    ...
    //   super(options)
    // }
    _transform(chunk, _ /* encoding: string */, done) {
        if (this.updated) {
            this.push(chunk);
        }
        else {
...
function updateLicense(file) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield fs_1.promises.link(tmpFile, file);
        // await promisify(unlinkCallback)(tmpFile)
        yield fs_1.promises.unlink(tmpFile);
    });
}
